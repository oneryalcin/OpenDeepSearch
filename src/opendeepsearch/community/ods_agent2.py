    ...
    def __init__(
        ...
        Args:
            ...
            source_processor_config (Dict[str, Any], optional): Configuration dictionary for the
                ...
                - credentials_path (str): Path to Google service account credentials for Vertex AI
                - project_id (str): Google Cloud project ID for Vertex AI
                - google_api_key (str): Google API key for direct Gemini API
                - output_dimensions (int): Output dimensions for Gemini embeddings
            ...
            reranker (str, default="infinity"): Identifier for the reranker to use. Options:
                - "infinity": Local semantic search using Infinity embeddings
                - "jina": Cloud-based reranking using Jina AI
                - "vertex": Cross-encoder reranking with Vertex AI Ranking
